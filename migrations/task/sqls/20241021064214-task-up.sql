...
((select id from "USER" where email = 'wXlTq@hexschooltest.io'),
  (select id from "COURSE" where name = '重訓基礎課'),
  '2024-11-24 16:00:00',
  '即將授課'
);
insert into "COURSE_BOOKING" (user_id, course_id , booking_at , status) values
...
insert into "COURSE_BOOKING" (user_id, course_id , booking_at , status) values
((select id from "USER" where email = 'wXlTq@hexschooltest.io'), (select id from "COURSE" where name = '重訓基礎課'), '2024-11-24 17:10:25', '即將授課');
...
select user_id , Count(*) from "COURSE_BOOKING" as "total"
where user_id = (select id from "USER" where email = 'wXlTq@hexschooltest.io')
...
select ("CREDIT_PURCHASE".total_credit - "COURSE_BOOKING".used_credit) as remaining_credit , "COURSE_BOOKING".user_id
...
where "CREDIT_PURCHASE".purchase_at BETWEEN '2024-11-01' AND '2024-11-30 23:59:59'
